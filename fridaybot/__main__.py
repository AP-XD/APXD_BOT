...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    wsta = "༒ 彡 ☣️𝔸ℙ 𝕏𝔻 ☣️ 彡 ༒ BOT Assistant Bot Have Been Installed Successfully !"
else:
    wsta = "༒ 彡 ☣️𝔸ℙ 𝕏𝔻 ☣️ 彡 ༒ BOT Has Been Installed Sucessfully !"
...
༒ 彡 ☣️𝔸ℙ 𝕏𝔻 ☣️ 彡 ༒ BOT Version : V{friday_version}
