...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Action Anime List For you !\n"
    )
...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Harem Anime List For you !\n"
    )
    msg_str = msg_str_front + msg_str
    msg_str = msg_str.replace("\\n", "\n")
    msg_str = msg_str.replace("'", "")
...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Mecha Anime List For you !\n"
    )
    msg_str = msg_str_front + msg_str
    msg_str = msg_str.replace("\\n", "\n")
    msg_str = msg_str.replace("'", "")
...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Romance Anime List For you !\n"
    )
    msg_str = msg_str_front + msg_str
    msg_str = msg_str.replace("\\n", "\n")
    msg_str = msg_str.replace("'", "")
...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Isekai Anime List For you !\n"
    )
    msg_str = msg_str_front + msg_str
    msg_str = msg_str.replace("\\n", "\n")
    msg_str = msg_str.replace("'", "")
...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Adventure Anime List For you !\n"
    )
    msg_str = msg_str_front + msg_str
    msg_str = msg_str.replace("\\n", "\n")
    msg_str = msg_str.replace("'", "")
...
async def action(event):
    ...
    msg_str = msg_str.replace("' '", "")
    msg_str_front = (
        "Here's Top " + str(number_of_times) + " Slice of life Anime List For you !\n"
    )
    msg_str = msg_str_front + msg_str
    msg_str = msg_str.replace("\\n", "\n")
    msg_str = msg_str.replace("'", "")
...
@friday.on(admin_cmd(pattern="animed (.*)"))
async def _(event):
    if event.fwd_from:
        return
