#"""Update fridaybot Code (FOR FRIDAY)
#Syntax: .update
#\nAll Credits goes to © @hellboi_atul @AP_XD
...
UPSTREAM_REPO_URL = "https://APXD-git:apgithub*123@github.com/APXD-git/APXD_BOT"
