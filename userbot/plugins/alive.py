...
pm_caption += "**Current Sat** : `丂𝙋⚡️ㄕ𝙄𝙆𝘼𝘾𝙃𝙐𒁂ᴾᴿᴼ𒋨ᵛᶰᴳᵒᵈシSat-2.25`\n"
pm_caption += f"**My Peru Owner** : {DEFAULTUSER} \n"
pm_caption += "**Heroku Database** : `AWS - Working Properly`\n\n"
pm_caption += "**License** : [MIT Licence](github.com/SP-PIKACHU/FridayUserbot/blob/master/LICENSE)\n"
pm_caption += "Copyright : By [丂𝙋⚡️ㄕ𝙄𝙆𝘼𝘾𝙃𝙐𒁂ᴾᴿᴼ𒋨ᵛᶰᴳᵒᵈシ@Github](github.com/SP-PIKACHU/FridayUserbot)\n"
