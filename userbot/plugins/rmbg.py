...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Removing Background. Plz wait...")
        try:
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed dat annoying Background in {} seconds, powered by @plusub".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @plusub\n`{}".format(output_file_name.content.decode("UTF-8")))
