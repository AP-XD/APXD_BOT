...
@borg(outgoing=True, pattern="^\,term(?: |$|\n)([\s\S]*)")
...
@borg(outgoing=True, pattern=r"^\,exec(?: |$)([\s\S]*)")
async def run(run_q):
...
@borg(outgoing=True, pattern="^\,eval(?: |$)(.*)")
...
@borg(outgoing=True, pattern="^\,hash (.*)")
...
@borg(outgoing=True, pattern="^\,base64 (en|de) (.*)")
